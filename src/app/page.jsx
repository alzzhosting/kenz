  ...
  return (
    <div className={styles.container}>
      <div className={styles.textContainer}>
        <h1 className={styles.title}>Kenz Rest API</h1>
        <p className={styles.desc}>
          Welcome everyone, welcome to Kenz API document home page. You can retrieve api data only in Kenz API and certainly without incurring any costs in data retrieval, 
